...
const games = [
  ...
  },
  {
    ...
    description:
      "Build the longest chain of related IELTS words against the clock. Sharpen your lexical range for band 7+.",
    badge: "SOON",
    badgeColor: "#f59e0b",
    available: false,
    tags: ["Solo", "Vocabulary", "Speed"],
    color: "#8b5cf6",
  },
  {
    id: "sentence-fix",
    ...
    subtitle: "Coming Soon",
    description:
      "Spot and fix grammar errors in IELTS-style sentences against a timer. Train your grammar eye for Writing.",
    badge: "SOON",
    badgeColor: "#f59e0b",
    available: false,
